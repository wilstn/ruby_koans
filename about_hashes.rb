...
class AboutHashes < Neo::Koan
  ...
  def test_accessing_hashes_with_fetch
    ...
    assert_raise(KeyError) do # Tests if the given block raises an exception.
    ...
    #
    # using fetch provides more options when encounter key doesn't exist
  ...
  def test_changing_hashes
    ...
    #
    # trying on irb there is syntax error when using literal. stackoverflow seems to have same conclusion:
  ...
  def test_hash_keys
    ...
    assert_equal Array, hash.keys.class # -> Hash#keys return an array: https://ruby-doc.org/core-2.4.1/Hash.html#method-i-keys
  end
  ...
  def test_default_value
    ...
    # If this hash is subsequently accessed by a key that doesn’t correspond to a hash entry,
